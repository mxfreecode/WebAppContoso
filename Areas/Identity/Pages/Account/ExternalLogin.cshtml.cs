...
namespace WebAppContoso.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                _logger.LogInformation("{Name} en sesión con {LoginProvider}.", info.Principal.Identity.Name, info.LoginProvider);
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        _logger.LogInformation("La usuario creó una cuenta usando {Name}.", info.LoginProvider);
                        ...
                        await _emailSender.SendEmailAsync(Input.Email, "Confirmar tu Correo",
                            $"Confirme su cuenta por <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>click Aquí</a>.");
